import 'package:eidweb/common/colors.dart';
...
ThemeData lightTheme = ThemeData(
    ...
    primarySwatch: MaterialColor(
      CommonColors.primary500.value,
      <int, Color>{
        50: CommonColors.primary50,
        100: CommonColors.primary100,
        200: CommonColors.primary200,
        300: CommonColors.primary300,
        400: CommonColors.primary400,
        500: CommonColors.primary500,
        600: CommonColors.primary600,
        700: CommonColors.primary700,
        800: CommonColors.primary800,
        900: CommonColors.primary900,
      },
    ),
    primaryColor: CommonColors.primary500,
    primaryColorBrightness: Brightness.light,
    primaryColorLight: CommonColors.primary200,
    primaryColorDark: CommonColors.primary900,
    ...
    hoverColor: CommonColors.primary100,
    highlightColor: CommonColors.primary500,
    splashColor: CommonColors.primary400,
//  splashFactory: # override create method from  InteractiveInkFeatureFactory
    ...
    buttonColor: CommonColors.primary500,
    secondaryHeaderColor: Colors.grey,
    textSelectionColor: Color(0xffB5BFD3),
    cursorColor: CommonColors.primary300,
    ...
    chipTheme: ChipThemeData(
        backgroundColor: CommonColors.primary500,
    ...
    colorScheme: ColorScheme(
        primary: CommonColors.primary500,
        primaryVariant: CommonColors.primary600,
        secondary: CommonColors.accent,
        secondaryVariant: CommonColors.accent,
        brightness: Brightness.light,
        background: Color(0xffB5BFD3),
        error: Colors.red,
        onBackground: Color(0xffB5BFD3),
        onError: Colors.red,
        onPrimary: CommonColors.primary500,
        onSecondary: CommonColors.accent,
